namespace SerExtraCore.Accounts {
    ...
    export namespace MoneyInRow {
        export const idProperty = 'Id';
        export const nameProperty = 'Remarks';
        export const localTextPrefix = 'Accounts.MoneyIn';
        export const lookupKey = 'Accounts.MoneyIn';

        export function getLookup(): Q.Lookup<MoneyInRow> {
            return Q.getLookup<MoneyInRow>('Accounts.MoneyIn');
        }
