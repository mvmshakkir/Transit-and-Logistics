namespace SerExtraCore.Transactions {
    export interface ConsignmentChargesForm {
    ...
    export class ConsignmentChargesForm extends Serenity.PrefixedContext {
        ...
        constructor(prefix: string) {
            ...
            if (!ConsignmentChargesForm.init)  {
                ConsignmentChargesForm.init = true;
                ...
                Q.initFormType(ConsignmentChargesForm, [
                    'ChargeId', w0,
                    'Date', w1,
                    'Description', w2,
                    'UOMId', w0,
