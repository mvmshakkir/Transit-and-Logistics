...
namespace SerExtraCore.Extr.Entities
{
    [ConnectionKey("Default"), Module("Extr"), TableName("[dbo].[ExtraExpense]")]
    [DisplayName("Extr"), InstanceName("Extr")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class ExtrRow : Row, IIdRow, INameRow
    {
