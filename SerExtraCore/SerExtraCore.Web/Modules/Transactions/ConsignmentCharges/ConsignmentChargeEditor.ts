...
namespace SerExtraCore.Transactions {
    import fld = ConsignmentChargesRow.Fields;
    @Serenity.Decorators.registerClass()
    export class ConsignmentChargeEditor extends Common.GridEditorBase<ConsignmentChargesRow> {
        ...
        protected initEntityDialog(itemType: string, dialog: Serenity.Widget<any>) {
            ...
            (dialog as ConsignmentChargesDialog).hidesupppieradvance = this.hidesupppieradvance;
        }
    }
}