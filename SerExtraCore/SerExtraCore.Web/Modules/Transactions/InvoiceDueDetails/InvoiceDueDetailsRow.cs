...
namespace SerExtraCore.Transactions.Entities
{
    ...
    [ConnectionKey("Default"), Module("Transactions"), TableName("[dbo].[InvoiceDueDetails]")]
    [DisplayName("Invoice Due Details"), InstanceName("Invoice Due Details")]
    [ReadPermission("Transactions:Invoice")]
    [ModifyPermission("Transactions:Invoice")]
    public sealed class InvoiceDueDetailsRow : Row, IIdRow
    {
