...
namespace SerExtraCore.Transactions.Entities
{
    ...
    [ConnectionKey("Default"), Module("Transactions"), TableName("[dbo].[SuppliersPaymentInvoices]")]
    [DisplayName("Suppliers Payment Invoices"), InstanceName("Suppliers Payment Invoices")]
    [ReadPermission("Transactions:SuppliersPayment")]
    [ModifyPermission("Transactions:SuppliersPayment")]
    public sealed class SuppliersPaymentInvoicesRow : Row, IIdRow
    {
        ...
        public String SuppliersPaymentDate
        {
        ...
        [DisplayName("Invoice Supplier Amount"), Expression("jInvoice.[SupplierAmount]")]
        public Decimal? InvoiceSupplierAmount
        {
            get { return Fields.InvoiceSupplierAmount[this]; }
            set { Fields.InvoiceSupplierAmount[this] = value; }
        }

        [DisplayName("Invoice Supplier Id"), Expression("jInvoice.[SupplierId]")]
        public Int32? InvoiceSupplierId
        {
            get { return Fields.InvoiceSupplierId[this]; }
            set { Fields.InvoiceSupplierId[this] = value; }
        }

        [DisplayName("Invoice Supplier Payment Status"), Expression("jInvoice.[SupplierPaymentStatus]")]
        public Decimal? InvoiceSupplierPaymentStatus
        {
            get { return Fields.InvoiceSupplierPaymentStatus[this]; }
            set { Fields.InvoiceSupplierPaymentStatus[this] = value; }
        }
        ...
        public SuppliersPaymentInvoicesRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField SuppliersPaymentDate;
            ...
            public DecimalField InvoiceSupplierAmount;
            public Int32Field InvoiceSupplierId;
            public DecimalField InvoiceSupplierPaymentStatus;
        }
    }
}
