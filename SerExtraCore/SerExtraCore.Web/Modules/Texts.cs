    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Calibre.Transit Password";
                ...
                {
                    public static LocalText FormTitle = "Calibre.Transit";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Calibre.Transit Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Calibre.Transit";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Calibre.Transit";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) "+DateTime.Today.Year+".";
                public static LocalText FooterInfo = "********     BitPro Technologies, For support : +91 8281 900 905,     support@bitpro-tech.com        .*********";
