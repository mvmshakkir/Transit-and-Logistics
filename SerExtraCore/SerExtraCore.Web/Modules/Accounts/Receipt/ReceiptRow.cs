...
namespace SerExtraCore.Accounts.Entities
{
    ...
    public sealed class ReceiptRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Employee Name"), Expression("jEmployee.[EmployeeName]"),QuickSearch,QuickFilter]
        ...
        [DisplayName("Ledger"), Expression("jCreditAccountHead.[Description]"),QuickSearch,QuickFilter]
        ...
        [DisplayName("Account"), Expression("jDebitAccount.[AccountName]"),QuickFilter,QuickSearch]
        ...
        [DisplayName("Credit Account Account Name"), Expression("jCreditAccount.[AccountName]")]
        ...
        [DisplayName("PDC Receipt Details"), ForeignKey("[dbo].[PDCPaymentDetails]", "Id"), LeftJoin("jPDCReceiptDetails")]
        public Int32? PDCReceiptDetailsId
        {
            get { return Fields.PDCReceiptDetailsId[this]; }
            set { Fields.PDCReceiptDetailsId[this] = value; }
        }

        [DisplayName("Consignment Advance ConsignmentId"), ForeignKey("[dbo].[Consignment]", "Id"), LeftJoin("jConsignment")]
        public Int32? ConsignmentAdvanceConsignmentId
        {
            get { return Fields.ConsignmentAdvanceConsignmentId[this]; }
            set { Fields.ConsignmentAdvanceConsignmentId[this] = value; }
        }
        ...
        [DisplayName("Invoice"), ForeignKey("[dbo].[Invoice]", "Id"), LeftJoin("jInvoiceId")]
		...
		[DisplayName("Trip"), ForeignKey("[dbo].[VehicleFreight]", "Id"), LeftJoin("jFreight")]
		...
		[DisplayName("Invoice"), ForeignKey("[dbo].[DeliveryServices]", "Id"), LeftJoin("jDeliveryServices")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field PDCReceiptDetailsId;
            public Int32Field ConsignmentAdvanceConsignmentId;
