...
namespace SerExtraCore.Accounts.Entities
{
    ...
    [LookupScript]
    public sealed class MoneyInRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("TS No"), ForeignKey("[dbo].[VehicleMovDetails]", "Id"), LeftJoin("jTrip"), TextualField("TSNo")]
        ...
        [DisplayName("Total Amount"), LookupInclude, Size(18), Scale(3), NotNull,ReadOnly(true)]
        ...
        [DisplayName("Ledger"), NotNull, ForeignKey("[dbo].[AccountHeads]", "ID"), LeftJoin("jAccountHead"), TextualField("AccountHeadDescription")]
        ...
        [DisplayName("Supplier Supplier Name"), Expression("jSupplier.[SupplierName]"), QuickFilter]
        ...
        [DisplayName("Receipts"), MasterDetailRelation(foreignKey: "MoneyInOutId"), NotMapped, AuditLog]
        [MinSelectLevel(SelectLevel.List)]
        ...
        [DisplayName("PDC Receipt Details"), MasterDetailRelation(foreignKey: "MoneyInOutId"), NotMapped]
