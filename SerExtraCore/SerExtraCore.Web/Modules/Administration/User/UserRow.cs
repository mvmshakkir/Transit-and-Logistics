...
namespace SerExtraCore.Administration.Entities
{
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("User Hierarchy"), ForeignKey("[dbo].[UserHierarchy]", "Id"), LeftJoin("jUserHierarchy"), TextualField("HierarchyName")]
        [LookupEditor(typeof(UserHierarchyRow), InplaceAdd = true)]
        public Int32? HierarchyId
        {
            get { return Fields.HierarchyId[this]; }
        ...
        [DisplayName("User Hierarchy"), Expression("jUserHierarchy.[HierarchyName]"),QuickFilter,QuickSearch]
