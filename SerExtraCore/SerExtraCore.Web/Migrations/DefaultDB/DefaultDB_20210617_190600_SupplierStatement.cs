...
{
    [Migration(20210617190600)]
    public class DefaultDB_20210617_190600_SupplierStatement : AutoReversingMigration
    {
        public override void Up()
        {

           this.Execute.Sql(@"Create view V_SupplierStatement
as
select * from(
	...
	union all
       ...
       from ConsignmentCharges ch
		...
		select Id,SupplierId,'Payment' as TrxType,Date as TrxDate,'' as TrxNo,'' as WayBillNo,' Payment ' as Description,DocumentNO as InvoiceNo,0 as TrxAmount,TotalAmount as Payment,PaymentType from SuppliersPayment
go");
        }
    }
}