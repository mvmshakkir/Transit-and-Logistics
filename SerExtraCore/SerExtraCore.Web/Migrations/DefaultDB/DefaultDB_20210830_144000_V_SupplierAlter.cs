...
{
    [Migration(20210830144000)]
    public class DefaultDB_20210830_144000_V_SupplierAlter : AutoReversingMigration
    {
...
select * from(
	...
	union all
       ...
       from ConsignmentCharges ch
		...
		union all
		select NULL as ConsignmentDate,'' as ConsignmentJobNo,Id,SupplierId,'Payment' as TrxType,TrxDate as TrxDate,'' as TrxNo,'' as WayBillNo,Remarks as Description,'' as InvoiceNo,0 as TrxAmount,Amount as Payment,PaymentMethod from JournalEntries where VType=2 and EntityType is null
		UNION ALL
		select NULL as ConsignmentDate,'' as ConsignmentJobNo,Id,SupplierId,'Reciept' as TrxType,TrxDate as TrxDate,'' as TrxNo,'' as WayBillNo,Remarks as Description,'' as InvoiceNo,0 as TrxAmount,-1*Amount as Payment,PaymentMethod from JournalEntries where VType=1 and EntityType is null
		union all
